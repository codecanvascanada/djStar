...
public class MissionManager : MonoBehaviour
{
    ...
    private void CheckAndResetDailyMissions()
    {
        ...
        else
        {
            ...
            Debug.Log("Same day. Loading existing daily missions.");
            LoadDailyMissions();
        }
    }
    ...
    private void CompleteMission(Mission mission)
    {
        if (!mission.isCompleted)
        {
            ...
            Debug.Log($"Mission Completed: {mission.description}! Rewarded {mission.rewardCoins} coins.");
    ...
    private void CheckAllMissionsCompleted()
    {
        if (currentDailyMissions.All(m => m.isCompleted))
        {
            ...
            Debug.Log($"All daily missions completed! Rewarded {allMissionsCompleteBonusCoins} bonus coins.");
        }
    }
