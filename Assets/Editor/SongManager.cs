...
{
    // ... (All previous sections up to Git Integration are correct and unchanged) ...
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                private string FindSourceAudio(string songId)
                {
            ...
            
                    {
                        ...
                        // ffmpeg -i "SOURCE_PATH" -q:a 5 -ar 44100 "OUTPUT_PATH.ogg"
            ...
            
                    {
                        ...
                        if (!Directory.Exists(SongsSourceBasePath)) { UnityEngine.Debug.LogWarning(string.Format("Song source path not found: {0}", SongsSourceBasePath)); return; }
    ...
    private void BuildSongs(List<SongMetadata> songsToBuild, bool forceRebuild)
    {
        ...
        ReloadData();
                            ...
                            string songInfoPath = FindSpecificAsset(song.id, "asset");
                                                        ...
                                                        // Print out exactly what is being added to the build map.
            
                                                        UnityEngine.Debug.Log($"[Build Log] For song '{song.id}':");
                                    ...
                                    var buildMapLog = new System.Text.StringBuilder();
            
                
            
                                    buildMapLog.AppendLine("[GEMINI_DEBUG] Build Map to be processed:");
            ...
            
                                    {
                                        ...
                                        buildMapLog.AppendLine($"  - Bundle Name: {build.assetBundleName}");
            ...
            
                                        {
                                            ...
                                            buildMapLog.AppendLine($"    - Asset: {asset}");
                                    ...
                                    UnityEngine.Debug.Log(buildMapLog.ToString());
                ...
                private void OpenSongListJsonFolder()
                {
                    ...
                    else UnityEngine.Debug.LogError(string.Format("Song Manager: SongList.json not found at {0}", SongListPath));
                }
                #endregion
